      ...
      <div className="fixed inset-0 w-full h-full flex items-center justify-center bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-violet-800/20 via-zinc-900 to-black z-50">
        <div className="flex flex-col items-center px-4 text-center">
          <div className="w-16 h-16 md:w-20 md:h-20 mb-4 relative">
            ...
            <div className="relative bg-gradient-to-br from-violet-600 to-indigo-600 rounded-full p-3 md:p-4 flex items-center justify-center">
          ...
          <h3 className="text-xl md:text-2xl font-bold text-white">Chargement...</h3>
          <p className="text-sm md:text-base text-zinc-400 mt-2">Vérification de l&apos;authentification</p>
        </div>
      </div>
    );
  }
